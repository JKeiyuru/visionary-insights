  ...
  return (
    <div className="min-h-screen grid place-items-center px-4 py-10">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md glass-strong rounded-3xl p-8 glow-ring">
        ...
        <h1 className="mt-6 font-display text-2xl font-semibold text-center">Join VisionPlay</h1>
        <p className="text-center text-sm text-muted-foreground">Start your forecasting journey today</p>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative mt-1">
              ...
              <Input id="name" required value={name} onChange={(e) => setName(e.target.value)} className="pl-9" placeholder="Your name" />
            </div>
          </div>
          <div>
