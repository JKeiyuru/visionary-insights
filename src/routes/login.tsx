      ...
      <div style={{ width: "100%", maxWidth: 400, position: "relative" }}>
        ...
        >
          <svg width="16" height="16" viewBox="0 0 24 24">
            <path
              fill="currentColor"
              d="M12 11v3.2h5.6c-.4 2.3-2.4 4-5.6 4-3.4 0-6.2-2.8-6.2-6.2S8.6 5.8 12 5.8c1.5 0 2.9.5 4 1.5l2.3-2.3C16.7 3.5 14.5 2.6 12 2.6 6.8 2.6 2.6 6.8 2.6 12s4.2 9.4 9.4 9.4c5.4 0 9-3.8 9-9.1 0-.6-.1-1.2-.2-1.7H12z"
            />
          </svg>
        ...
        >
          ...
          <Link
            to="/signup"
            style={{ color: "#fff", textDecoration: "none", borderBottom: "0.5px solid rgba(255,255,255,0.3)", paddingBottom: 1 }}
          >
            Create an account
          </Link>
        </p>
